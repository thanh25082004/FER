  ...
  return (
    <Container className="d-flex justify-content-center align-items-center min-vh-100" style={{ backgroundColor: "#ffe6f2" }}>
      <Card className="shadow-lg p-4" style={{ width: '28rem' }}>
        ...
        />
        <Card.Body>
          <Card.Title className="fw-bold text-center">{product.brand}</Card.Title>
          <Card.Text><strong>model:</strong> {product.model}</Card.Text>
          <Card.Text><strong>year:</strong> ${product.year}</Card.Text>
